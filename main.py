...
async def create_product(
    ...
    if db_product:
        return await _services.create_price_for_product(db_product.id, total_price, price_url, db)

    written_product = await _services.create_product(product, db)

    return await _services.create_price_for_product(written_product.id, total_price, price_url, db)
